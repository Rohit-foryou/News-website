...
const News = (props) => {
 ...
 const handlePrevClick = async () => {
  ...
  const fetchMoreData = async () => {
    setPage(page + 1);
    const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=fa3dbec13bb44cd2a222250b4aea8871&page=${page - 1}&pageSize=${pageSize}`;
