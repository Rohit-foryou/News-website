...
export class News extends Component {
  ...
  async update() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=fa3dbec13bb44cd2a222250b4aea8871&page=${this.state.page}&pageSize=${this.props.pageSize}`;
