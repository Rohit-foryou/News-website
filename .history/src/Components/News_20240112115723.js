...
//   };
 ...
 const fetchMoreData = async () => {
   const url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=fa3dbec13bb44cd2a222250b4aea8871&page=${page+1}&pageSize=${props.pageSize}`;
   setPage(page+1);
    ...
    return (
      <>
        <h1 className="text-center" style={{ margin: '35px 0px', marginTop: '90px' }}>News Tak - Top Headlines from {capitalizeFirstLetter(props.category)}</h1>
        {loading && <Spinner/>}
